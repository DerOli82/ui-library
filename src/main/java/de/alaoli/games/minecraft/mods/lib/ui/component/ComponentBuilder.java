 ...
 *
 * You should have received a toCopy of the GNU Lesser General Public License
...
abstract class ComponentBuilder<P, S extends ComponentBuilder<P,S,B>,B> extends NestedBuilder<P,S,B>
{
    ...
    public RegionBuilder<S> withRegion()
    {
        ...
        {
            this.regionBuilder = Styles.newRegionBuilder();
            this.regionBuilder.withParentBuilder( this.self() );
        }
