...
import de.alaoli.games.minecraft.mods.lib.ui.component.TextAreaBuilder;
 ...
 */
public class TextAreaTheme implements ThemeComponent<TextAreaBuilder<?>>
{
    /* *************************************************************************************************************
    ...
    @Override
    public void applyOn( TextAreaBuilder<?> builder )
    {
        ...
        builder.withBoxStyle()
            .withState( State.NONE )
                .withPadding().withSpacing( 4 ).done()
